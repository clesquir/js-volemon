...
export default class BigJumpMonsterBonus extends MonsterBonus {
	...
	start() {
		this.game.changePlayerProperty.call(this.game, this.activatorPlayerKey, 'verticalMoveMultiplier', 1.35);
	}

	stop() {
		this.game.changePlayerProperty.call(this.game, this.activatorPlayerKey, 'verticalMoveMultiplier', 1);
